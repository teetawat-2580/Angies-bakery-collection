...
const dialogues = {
    ...
    qna: [
        ...
        {
            title: 'Q8: คุกกี้ที่วางโชว์อยู่ในตู้กระจกเป็นของจริงไหม? (Real Cookie Showcase Hook)',
            tag: 'ชวนคุยจากความสนใจ & เปิดการขาย',
            text: '"ของจริง 100% อบสดใหม่ทุกวันเลยครับ/ค่ะ! สังเกตตรงเนยสดฝรั่งเศส 🇫🇷 กับไส้นูเทลล่า 🇮🇹 เยิ้มๆ ได้เลยครับ ถ้าเป็นโมเดลปลอมทำความฉ่ำเนียนแบบนี้ไม่ได้แน่นอนครับ 😄 แนะนำว่าถ้านำกลับบ้าน เข้าเวฟ 10-15 วินาที ไส้จะเยิ้มฉ่ำเหมือนที่เห็นในตู้เป๊ะๆ เลยครับ วันนี้สนใจเป็นดาร์กช็อกโกแลตฝรั่งเศส หรือนูเทลล่าไส้เยิ้มดีครับ?"',
            tip: 'เปลี่ยนคำถามความสนใจให้เป็นโอกาสเชิญชวนเลือกชิมรสชาติที่โชว์ไส้เยิ้ม'
        }
    ],
    upsell: [
        {
